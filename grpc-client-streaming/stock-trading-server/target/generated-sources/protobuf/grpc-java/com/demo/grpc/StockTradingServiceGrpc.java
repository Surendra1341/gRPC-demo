...
public final class StockTradingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.StockRequest,
      com.demo.grpc.StockResponse> getGetStockPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getStockPrice",
      requestType = com.demo.grpc.StockRequest.class,
      responseType = com.demo.grpc.StockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.StockRequest,
      com.demo.grpc.StockResponse> getGetStockPriceMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.StockRequest, com.demo.grpc.StockResponse> getGetStockPriceMethod;
      ...
      synchronized (StockTradingServiceGrpc.class) {
        if ((getGetStockPriceMethod = StockTradingServiceGrpc.getGetStockPriceMethod) == null) {
          StockTradingServiceGrpc.getGetStockPriceMethod = getGetStockPriceMethod =
              io.grpc.MethodDescriptor.<com.demo.grpc.StockRequest, com.demo.grpc.StockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getStockPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.StockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.StockResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.StockRequest,
      com.demo.grpc.StockResponse> getSubscribeStockPriceMethod;
  ...
  public static io.grpc.MethodDescriptor<com.demo.grpc.StockRequest,
      com.demo.grpc.StockResponse> getSubscribeStockPriceMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.StockRequest, com.demo.grpc.StockResponse> getSubscribeStockPriceMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.StockOrder,
      com.demo.grpc.OrderSummary> getBulkStockOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "bulkStockOrder",
      requestType = com.demo.grpc.StockOrder.class,
      responseType = com.demo.grpc.OrderSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.demo.grpc.StockOrder,
      com.demo.grpc.OrderSummary> getBulkStockOrderMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.StockOrder, com.demo.grpc.OrderSummary> getBulkStockOrderMethod;
      ...
      synchronized (StockTradingServiceGrpc.class) {
        if ((getBulkStockOrderMethod = StockTradingServiceGrpc.getBulkStockOrderMethod) == null) {
          StockTradingServiceGrpc.getBulkStockOrderMethod = getBulkStockOrderMethod =
              io.grpc.MethodDescriptor.<com.demo.grpc.StockOrder, com.demo.grpc.OrderSummary>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "bulkStockOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.StockOrder.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.OrderSummary.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getStockPrice(com.demo.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse> responseObserver) {
     ...
     * </pre>
     */
    default void subscribeStockPrice(com.demo.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.demo.grpc.StockOrder> bulkStockOrder(
        io.grpc.stub.StreamObserver<com.demo.grpc.OrderSummary> responseObserver) {
  ...
  public static final class StockTradingServiceStub
     ...
     * </pre>
     */
    public void getStockPrice(com.demo.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse> responseObserver) {
     ...
     * </pre>
     */
    public void subscribeStockPrice(com.demo.grpc.StockRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.demo.grpc.StockOrder> bulkStockOrder(
        io.grpc.stub.StreamObserver<com.demo.grpc.OrderSummary> responseObserver) {
  ...
  public static final class StockTradingServiceBlockingV2Stub
     ...
     * </pre>
     */
    public com.demo.grpc.StockResponse getStockPrice(com.demo.grpc.StockRequest request) {
    ...
    public io.grpc.stub.BlockingClientCall<?, com.demo.grpc.StockResponse>
        subscribeStockPrice(com.demo.grpc.StockRequest request) {
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<com.demo.grpc.StockOrder, com.demo.grpc.OrderSummary>
        bulkStockOrder() {
  ...
  public static final class StockTradingServiceBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<com.demo.grpc.StockResponse> subscribeStockPrice(
        com.demo.grpc.StockRequest request) {
  ...
  public static final class StockTradingServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.StockResponse> getStockPrice(
        com.demo.grpc.StockRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_PRICE:
          serviceImpl.getStockPrice((com.demo.grpc.StockRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse>) responseObserver);
          break;
        case METHODID_SUBSCRIBE_STOCK_PRICE:
          serviceImpl.subscribeStockPrice((com.demo.grpc.StockRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.StockResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.demo.grpc.StockRequest,
              com.demo.grpc.StockResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.demo.grpc.StockOrder,
              com.demo.grpc.OrderSummary>(
  ...
  private static abstract class StockTradingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.grpc.StockTradingProto.getDescriptor();
    }
